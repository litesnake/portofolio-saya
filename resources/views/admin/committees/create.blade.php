...
<div class="max-w-3xl mx-auto">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800">Tambah Committee Baru</h1>
        <p class="text-gray-600 text-sm mt-1">Isi form di bawah untuk menambahkan riwayat kepanitiaan</p>
    </div>

    <form action="{{ route('admin.committees.store') }}" method="POST" class="glass-card p-8">
        @csrf
